...
It deliberately depends on :class:`fast_cli.output.output` and
:class:`fast_cli.venv.VirtualEnvironmentService` only for activation command
...
class GenerationSummaryPresenter:
    ...
    :class:`fast_cli.project_generation.ProjectGenerationOrchestrator`, extended
