...
* :class:`fastx_cli.gitignore.GitignoreUpdater` / :class:`fastx_cli.venv.VirtualEnvironmentService`
  / :class:`fastx_cli.precommit.PreCommitInstaller` — post-copy setup
* :class:`fastx_cli.generation_ui.GenerationSummaryPresenter` — UX
...
See Also
--------
fastx_cli.commands.generate_cmd.register_generate_commands : CLI registration.
"""
